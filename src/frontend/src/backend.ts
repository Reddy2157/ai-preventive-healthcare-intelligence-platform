...
export class Backend implements backendInterface {
    ...
    async deleteRecord(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getAllRecords(): Promise<Array<HealthRecord>> {
        if (this.processError) {
            try {
    ...
    async getRecordById(arg0: string): Promise<HealthRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecordById(arg0);
                return from_candid_HealthRecord_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getRecordsByPatientName(arg0: string): Promise<Array<HealthRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecordsByPatientName(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
