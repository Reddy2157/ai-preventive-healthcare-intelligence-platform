...
export function XRayResultChart({
  normalProb,
  pneumoniaProb,
}: XRayResultChartProps) {
  return (
    <div className="space-y-3">
      <div className="space-y-1.5">
        <div className="flex justify-between text-sm font-medium">
          <span className="text-health-green">Normal</span>
          <span className="text-health-green font-semibold">
      ...
      <div className="space-y-1.5">
        <div className="flex justify-between text-sm font-medium">
          ...
          <span className="text-health-red font-semibold">
            {(pneumoniaProb * 100).toFixed(1)}%
          </span>
        </div>
        <div className="h-3 bg-muted rounded-full overflow-hidden">
          <div
