...
export default function RiskPredictor() {
  ...
  const numericForm = {
    age: Number.parseFloat(form.age) || 0,
    bmi: Number.parseFloat(form.bmi) || 0,
    bloodPressure: Number.parseFloat(form.bloodPressure) || 0,
    glucose: Number.parseFloat(form.glucose) || 0,
    hemoglobin: Number.parseFloat(form.hemoglobin) || 0,
    cholesterol: Number.parseFloat(form.cholesterol) || 0,
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Enter patient vitals and lab results to calculate cardiovascular risk
          score.
        </p>
      </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, cholesterol: e.target.value })
                    }
                  />
                </div>
              </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {[
                    ...
                    { label: "BMI", value: numericForm.bmi.toFixed(1) },
                    {
                      ...
                      value: `${numericForm.bloodPressure} mmHg`,
                    },
                    { label: "Glucose", value: `${numericForm.glucose} mg/dL` },
                    {
                      label: "Hemoglobin",
                      value: `${numericForm.hemoglobin} g/dL`,
                    },
                    {
                      label: "Cholesterol",
                      value: `${numericForm.cholesterol} mg/dL`,
                    },
