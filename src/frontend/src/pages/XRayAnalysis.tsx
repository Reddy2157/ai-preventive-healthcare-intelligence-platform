...
function simulateClassification(file: File): Promise<ClassificationResult> {
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      resolve({
        normal: Number.parseFloat(normal.toFixed(1)),
        pneumonia: Number.parseFloat(pneumonia.toFixed(1)),
        confidence: Number.parseFloat(Math.max(normal, pneumonia).toFixed(1)),
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Medical Disclaimer:</strong> This tool provides simulated
          results for demonstration purposes only. It is not a substitute for
